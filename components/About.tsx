...
const About: React.FC = () => {
  return (
    <section id="about" className="w-screen h-full flex items-center justify-center px-6 md:px-24 flex-shrink-0 bg-white relative snap-start overflow-y-auto md:overflow-hidden">
      <div className="max-w-4xl w-full py-12 md:py-0">
        <div className="flex flex-col md:flex-row gap-6 md:gap-24 items-start">
          <div className="w-full md:w-1/3">
             <FadeInSection>
              <h2 className="text-xs md:text-sm uppercase tracking-widest text-gray-400 font-medium mb-4">About Me</h2>
              <div className="h-1 w-12 bg-black mb-4 md:mb-8"></div>
            </FadeInSection>
          </div>
          
          <div className="w-full md:w-2/3">
            <FadeInSection delay="0.2s">
              <p className="text-xl md:text-4xl leading-snug font-medium mb-6 md:mb-12 text-primary">
                Hi! I’m Alex Lavru - crafting digital experiences where design meets precision.
              </p>
              <p className="text-base md:text-lg text-gray-600 leading-relaxed mb-4 md:mb-8 max-w-xl">
                I create intuitive, engaging interfaces that transform complex challenges into simple, elegant solutions.
              </p>
              <p className="text-base md:text-lg text-gray-600 leading-relaxed mb-8 md:mb-12 max-w-xl">
              ...
              <button className="group relative inline-flex items-center gap-3 text-base md:text-lg font-medium hover:text-gray-600 transition-colors">
