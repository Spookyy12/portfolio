...
export const ProjectsIntro: React.FC = () => {
  return (
    <section className="w-full h-full flex items-center justify-center bg-gray-50 px-6 md:px-24">
      <div className="max-w-4xl text-center md:text-left w-full">
        <FadeInSection>
...
export const ProjectSlide: React.FC<ProjectSlideProps> = ({ project, index, total }) => {
  ...
  return (
    <article className="w-full h-full relative group overflow-hidden">
      ...
      {/* Content - Adjusted padding for mobile to avoid overlap with bottom navigation/address bar */}
      <div className="absolute inset-0 flex flex-col justify-end p-6 pb-24 md:p-24 md:pb-24 text-white">
        <FadeInSection delay="0.2s">
          <div className="border-l-2 border-white pl-4 md:pl-8">
